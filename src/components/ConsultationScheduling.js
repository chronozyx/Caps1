...
export default function ConsultationScheduling() {
  ...
  return (
    <div className="mt-8 p-6 bg-white rounded-xl shadow-md border border-gray-300">
      <h2 className="text-2xl font-bold text-blue-800 mb-4">Consultation Scheduling</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          <label className="block font-medium">Doctor Specialist:</label>
          <select
      ...
      <div className="mt-6">
        <h3 className="text-lg font-semibold mb-2">Doctor's Available Schedules</h3>
        <div className="space-y-4">
          {doctorSchedules.map((doc, index) => (
            <div key={index} className="p-4 border border-gray-200 rounded bg-gray-50">
              <h4 className="font-bold text-md">{doc.name}</h4>
